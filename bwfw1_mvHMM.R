bwfw1_mvHMM<-function(z, A, mu_0, Sigma_0, mu_1, Sigma_1)
{


## DETAILS
 # bwfw1_mvHMM calculates values for backward, forward variables, probabilities of hidden states, 
...
## Densities
    ...
    for(i in 1:NUM)
    {
        f1z[i]<-dmvnorm(z[, i], mean = mu_1, sigma = Sigma_1, log = FALSE) 
    }
